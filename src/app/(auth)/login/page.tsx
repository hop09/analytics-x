...
import { Mail, Lock, Zap, Eye, EyeOff, Loader2, AlertCircle } from "lucide-react";
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center mb-6 sm:mb-8">
                ...
                <h1 className="text-xl sm:text-2xl font-bold heading-gradient">Welcome back</h1>
                <p className="text-text-muted text-xs sm:text-sm mt-1">Sign in to your HOP Analytics account</p>
            </div>
            ...
            <div className="mt-5 sm:mt-6 text-center space-y-3">
                <p className="text-xs sm:text-sm text-text-muted">
                    ...
                    <Link href="/register" className="text-accent-indigo hover:text-indigo-400 font-medium transition-colors">
                        Create one
                    </Link>
                </p>
            </div>
