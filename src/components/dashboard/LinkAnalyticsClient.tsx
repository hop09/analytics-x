        ...
        <PageTransition>
            <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "32px" }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <p style={{ fontSize: "12px", color: "#94a3b8", marginTop: "4px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                        {link.original_url}
                    </p>
                </div>
            </div>
                    ...
                    {botHumanData.length > 0 ? (
                        <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                            <ResponsiveContainer width="100%" height={180}>
                                <PieChart>
                                    <Pie data={botHumanData} cx="50%" cy="50%" innerRadius={50} outerRadius={75} paddingAngle={4} dataKey="value">
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "16px" }}>
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.5 }} style={cardStyle}>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.6 }} style={cardStyle}>
                    <div style={breakdownHeaderStyle}>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.7 }} style={cardStyle}>
                    <div style={breakdownHeaderStyle}>
