    ...
    return (
        <PageTransition>
            <div style={{ marginBottom: "36px" }}>
                ...
                <p style={{ fontSize: "15px", color: "#94a3b8", marginTop: "4px", fontWeight: 400 }}>
                        ...
                        {recentClicks.map((click, index) => (
                            ...
                            >
                                <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
                                    ...
                                    <div>
                                        ...
                                        <div style={{ display: "flex", alignItems: "center", gap: "6px", marginTop: "2px" }}>
                                            <Globe size={12} color="#d1d5db" />
                                            <span style={{ fontSize: "12px", color: "#9ca3af" }}>{click.country || "Unknown"}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                                    ...
                                    <span style={{ fontSize: "12px", color: "#d1d5db", minWidth: "50px", textAlign: "right" }}>
